    ...
    <div class="mx-auto px-4">
        <div class="chat chat-start">
            <div class="chat-bubble chat-bubble-secondary">
                <h2>Page Transfert</h2>
            </div>
        </div>

        <h5 class="text-l font-semibold ">Veuillez sélectionner la date et la structure</h5>

        <div class="grid grid-cols-3 gap-6 max-w-xl">
            <div class="form-control">
                <label for="mois" class="label"><span class="label-text">Mois</span></label>
                <input type="date" id="mois" class="input input-bordered w-full" v-model="mois" />
            </div>
            <div class="form-control">
